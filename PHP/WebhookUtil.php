 ...
 * @WebhookUtil
 *
 * EN: This software was developed by hearlov. It works with PHP software!
 * TR: Bu yazılım hearlov tarafından üretilmiştir. PHP yazılımlarında çalışır!
 */
class WebHookUtil{
	...
	*/
    ...
    public function sendWebhook(){
        ...
        curl_setopt($curl, CURLOPT_POSTFIELDS, json_encode($this->json_array));
